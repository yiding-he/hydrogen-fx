...
public class FormDialogTest {
    ...
    public static void main(String[] args) {
        Application.launch(FormDialogTestApp.class, args);
    }

    public static class FormDialogTestApp extends Application {
        ...
        public static class MyFormDialog extends FormDialog {
            ...
            public MyFormDialog(Stage owner) {
                super(owner);
                addField(new TextFormField()
                    .label("名字").text("1231231")
                    .validation(f -> {
                ...
                addField(new IntegerSpinnerFormField()
                    .label("大小").min(1).max(1000).value(444).editable(true)
                    .validation(f -> {
                        if (f.getValue() < 300) {
